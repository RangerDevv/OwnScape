...
const styles = StyleSheet.create({
  ...
  logoBadge: {
    width: 52, height: 52, backgroundColor: '#ffe600', borderRadius: 8, borderWidth: 3, borderColor: '#000000',
  ...
  primaryButton: {
    backgroundColor: '#ffe600', borderRadius: 8, paddingVertical: 16, alignItems: 'center', marginTop: 4,
